...
function placeDockInsideComposer(dock, documentRef = document) {
  if (dock === null || dock === void 0) return () => {
  };
  ...
  if (composer === null || composer === void 0 || scroll === null || scroll === void 0 || origin === null || origin === void 0 || origin === composer) return () => {
  };
  ...
  return () => {
    ...
    if (marker.parentNode !== null && marker.parentNode !== void 0) {
...
function FileResourceDock({ sessionId, input, t }) {
  ...
  import_react.default.useLayoutEffect(() => {
    ...
    const unbind = dock?.dataset?.composerAttachment === "true" ? bindComposerDockActions(
      dock,
